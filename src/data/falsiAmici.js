...
// PLAN.md says La Mappatura is where *most* of these get generated, not all, and
...
// the tempting wrong answer — La Mappatura's own trap-drill shape, and PLAN.md's
...
const OWN = [
  ...
  },
  {
    ...
    note: "La Mappatura mentions this one in passing, on the drill where kolacja lands on cena. It is written down as a trap here, which is the only place the app can show it to you before it catches you.",
...
// The trap word as a learner would type it. La Mappatura writes `l'attualità`
...
export const TRAP_SETS = [
  {
    ...
    accent: "lemon",
    blurb:
      "A suffix rule gets the shape right and has no opinion about the meaning, so every map hands you a few confident mistakes along with the few hundred words. La Mappatura names them on the card that creates them; this is where they are kept.",
    traps: fromMaps(),
  },
  {
    id: "altri",
...
// between La Mappatura and this bench: a mapping drill that produces a `trap`
