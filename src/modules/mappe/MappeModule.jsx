...
// Mappatura delle parole — the first of L'Officina's workbenches, and the
// app's first production exercise: every other mode picks from options, this
// one asks you to write the Italian.
//
...
function MappaBar({ map, onBack }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
      <BackLink label="Mappatura delle parole" onClick={onBack} />
...
// opened it at the top level went.
export default function MappeModule({ onExit, exitLabel = "All modules" }) {
  ...
  // markWord rather than reviewItem: Mappatura delle parole is deliberately outside the
