...
// La Mappatura added no new shape to the blob — only a namespace inside the map
// every other module already writes into. That is the property worth pinning:
// a save written before La Mappatura existed has to keep loading, and a mapping
...
describe("mappeKey / mapKnownCount", () => {
  ...
  it("reads a save written before La Mappatura existed as nothing drilled", () => {
